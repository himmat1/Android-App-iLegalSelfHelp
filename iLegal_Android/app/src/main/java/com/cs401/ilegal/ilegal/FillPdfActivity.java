                    ...
                    if(resultJson.getString("Success").equals("true"))
                    {
                        ...
                        for(int i=0;i<fieldsArray.length();i++)
                        {
                            ...
                            else if(type.equals("Tx"))//text fields to fill
                            {
                                ...
                                EditText theTextfield = new EditText(FillPdfActivity.this);
                ...
                try
                {
                    ...
                    for(int i=0;i<fieldsArray.length();i++)
                    {
                        ...
                        else if (type.equals("Ch"))//dropdown field
                        {
                            ...
                            Log.d("is this drppdown value?",selectedText);
                        ...
                        else if (type.equals("Tx"))//text fields to fill
                        {
                            ...
                            Log.d("is this checkbox value?",value);

                            fillFieldObject.put("type","Tx");
                            fillFieldObject.put("value",value);
                        }
